...
class Config:
    ...
    SP500_SYMBOLS = [
        ...
        'AVGO', 'KO', 'LLY', 'WMT', 'MRK', 'PEP', 'COST', 'TMO', 'DHR', 'NEE',
        'VZ', 'ABT', 'ADBE', 'NFLX', 'CRM', 'CMCSA', 'ACN', 'INTC', 'NKE', 'TXN',
        'AMD', 'QCOM', 'UPS', 'PM', 'HON', 'T', 'RTX', 'LOW', 'SPGI', 'IBM'
    ]
    ...
    def validate_config(cls):
        ...
        if missing_keys:
            logging.warning(f"Missing API keys: {missing_keys}. Some features may not work.")
